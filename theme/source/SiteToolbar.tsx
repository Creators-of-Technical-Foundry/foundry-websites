import { component$, useContext, type JSXOutput } from "@qwik.dev/core";
    ...
    return (
        <nav class="w-11/12 mx-auto xl:w-6xl fixed top-0 left-1/2 -translate-x-[50%] h-18 z-150 flex flex-row gap-3 justify-between items-center">
            ...
            <button
                ...
                onClick$={() => documentState.theme.value == "light"
                                ? documentState.theme.value = "dark"
                                : documentState.theme.value = "light"}
            >
                <span
